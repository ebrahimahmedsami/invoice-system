...
/*    function __construct(){
    ...
    public function show($id){
        $role = Role::find($id);$rolePermissions = Permission::join("role_has_permissions","role_has_permissions.permission_id","=","permissions.id")
    ...
    public function edit($id){
        ...
        $rolePermissions = DB::table("role_has_permissions")
            ...
            ->all();return view('roles.edit',compact('role','permission','rolePermissions'));
    }
