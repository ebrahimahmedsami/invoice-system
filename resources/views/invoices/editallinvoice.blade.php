...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{url('invoice/update')}}" method="post" enctype="multipart/form-data"
                          autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section" class="form-control SlectBox" onchange="console.log('change is firing')">
                                    <!--placeholder-->
                                    <option value="{{$invoice->sections->id}}" selected> {{$invoice->sections->section_name}}</option>
                                    @foreach($sections as $section)
                                        @if($section->id == $invoice->sections->id)
                                            <option value="{{$section->id}}" disabled>{{$section->section_name}}</option>
                                        @else
    ...
    <script>
        function myFunction() {
            ...
            if (typeof Amount_Commission === 'undefined' || !Amount_Commission) {
                $('.card-body').prepend('<div class="invoice-warning alert alert-warning">يرجي ادخال مبلغ العمولة</div>');
            } else {
