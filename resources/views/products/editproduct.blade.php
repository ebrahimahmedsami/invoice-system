...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الإعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل منتج</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <div class="col-lg-12">
                            <div class="bg-gray-200 p-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="exampleInputEmail1" name="product_name" type="text" value="{{$product->product_name}}">
                                    @error('product_name')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="product_desc">{{$product->description}}</textarea>
                                    @error('product_desc')
                                    <small class="form-text text-danger">{{$message}}</small>
                                    @enderror
                                </div>
