<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
                <a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><h4>Invoices Company</h4></a>
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('all.invoices')}}">قائمة الفواتير</a></li>
							<li><a class="slide-item" href="#">الفواتير المدفوعة</a></li>
							<li><a class="slide-item" href="#">الفواتير الغير مدفوعة</a></li>
							<li><a class="slide-item" href="#">الفواتير المدفوعة جزئيا</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="#">الصلاحيات</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('all.sections')}}">الأقسام</a></li>
							<li><a class="slide-item" href="{{route('all.products')}}">المنتجات</a></li>
						</ul>
					</li>
